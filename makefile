...
${shelldir}shell:
	...
	clang -c ${shelldir}redirect_execute.c
	clang -o shell ${shelldir}shell.c execute_parser.o type_parser.o operands_t.o user_interface.o builtin_cd.o pipe_parser.o pipe_execute.o redirect_parser.o redirect_execute.o
clean:
	rm -rf shell
